...
Google Meet module for the [Zerp](https://github.com/zerp-pk) ERP platform. Schedule and manage Google Meet video conferences via Google Calendar integration for the Zerp ERP platform
